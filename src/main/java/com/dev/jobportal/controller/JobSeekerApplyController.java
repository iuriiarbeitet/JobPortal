...
import com.dev.jobportal.service.*;
...
public class JobSeekerApplyController {
    ...
    public String apply(@PathVariable("id") int id, JobSeekerApply jobSeekerApply) {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            for (JobSeekerApply jobSeekerApply1 : jobSeekerApplyList){
                if (jobSeekerApply1.getUserId() == jobSeekerApply.getUserId()){
                    jobSeekerApplyService.delete(jobSeekerApply1.getId());
                    flagSearch = false;
                    break;
                }
            }
            if (flagSearch) jobSeekerApplyService.addNew(jobSeekerApply);
        }
